...
},{}],"lib/PlugAPI.ts":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ROLE = exports.MUTE = exports.EVENTS = exports.BAN = void 0;
var BAN;
...
(function (EVENTS) {
  ...
  EVENTS["CHAT"] = "chat";
  EVENTS["CHAT_COMMAND"] = "chatCommand";
  EVENTS["FRIEND_JOIN"] = "friendJoin";
  EVENTS["GRAB_UPDATE"] = "grabUpdate";
  EVENTS["HISTORY_UPDATE"] = "historyUpdate";
  EVENTS["MOD_SKIP"] = "modSkip";
  EVENTS["SCORE_UPDATE"] = "scoreUpdate";
  EVENTS["USER_JOIN"] = "userJoin";
  EVENTS["USER_LEAVE"] = "userLeave";
  EVENTS["USER_SKIP"] = "userSkip";
  EVENTS["VOTE_UPDATE"] = "voteUpdate";
  EVENTS["WAIT_LIST_UPDATE"] = "waitListUpdate";
...
(function (MUTE) {
  ...
  MUTE["MEDIUM"] = "m";
  MUTE["LONG"] = "l";
})(MUTE = exports.MUTE || (exports.MUTE = {}));

var ROLE;

(function (ROLE) {
  ROLE[ROLE["BOUNCER"] = 2000] = "BOUNCER";
  ROLE[ROLE["COHOST"] = 4000] = "COHOST";
  ROLE[ROLE["DJ"] = 1000] = "DJ";
  ROLE[ROLE["HOST"] = 5000] = "HOST";
  ROLE[ROLE["MANAGER"] = 3000] = "MANAGER";
  ROLE[ROLE["NONE"] = 0] = "NONE";
})(ROLE = exports.ROLE || (exports.ROLE = {}));
},{}],"lib/Database.ts":[function(require,module,exports) {
"use strict";
...
var BotDatabase = /*#__PURE__*/function () {
  function BotDatabase() {
    _classCallCheck(this, BotDatabase);

    this.db = window.openDatabase('bot', '1.0', 'Bot', 102400);
  }

  _createClass(BotDatabase, [{
    key: "query",
    value: function () {
      var _query = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(sql, params) {
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", this.transaction(function (runner) {
    ...
    key: "transaction",
    value: function () {
      var _transaction = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(cb) {
        var _this = this;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", new Promise(function (resolve, reject) {
                  _this.db.readTransaction(function (trx) {
                    resolve(cb({
                      trx: trx,
                      query: function query(sql) {
                        var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
                        return new Promise(function (resolve, reject) {
                          trx.executeSql(sql, params, function (transaction, result) {
...
},{}],"lib/Blacklist.ts":[function(require,module,exports) {
"use strict";
...
var BlackList = /*#__PURE__*/function () {
  function BlackList() {
    var defaultTime = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 1000;
  ...
  _createClass(BlackList, [{
    ...
    value: function flush() {
      ...
      this.checkDisposed();
      this.items.forEach(function (timestamp, item, map) {
        if (!_this.timeOf(item)) {
          var listener = _this.listeners.get(item);
    ...
    value: function add(item) {
      var time = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.defaultTime;
    ...
    key: "timeOf",
    value: function timeOf(item) {
      var _this$items$get;

      var exp = (_this$items$get = this.items.get(item)) !== null && _this$items$get !== void 0 ? _this$items$get : 0;
...
BlackList.instances = new Set();
BlackList.global = new BlackList();
setInterval(function () {
  BlackList.instances.forEach(function (instance) {
    return instance.flush();
  });
}, 100);
},{}],"lib/Bot.ts":[function(require,module,exports) {
"use strict";
...
var Bot = /*#__PURE__*/function () {
  function Bot() {
    ...
    this.db = new Database_1.BotDatabase();
    this.commands = new Set();
    this.modules = new Set();
    this.markedToDelete = new Blacklist_1.BlackList();
  }
  ...
  _createClass(Bot, [{
    ...
    key: "commandListener",
    value: function commandListener(cmd) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var match = cmd.match(command.command);
    ...
    key: "initDatabase",
    value: function () {
      var _initDatabase = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                this.db.transaction( /*#__PURE__*/function () {
                  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(runner) {
                    return regeneratorRuntime.wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            console.log('TRANSACAO', runner); // await runner.query(`
    ...
    key: "userIsInWaitList",
    value: function userIsInWaitList(username) {
      return this.getWaitList().some(function (u) {
        return u.username === username;
      });
    }
  }, {
    key: "moveDj",
    value: function moveDj(username, position) {
      var user = window.API.getWaitList().find(function (u) {
        return u.username === username;
      });
    ...
    value: function () {
      var _init = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
        ...
        var _iterator2, _step2, module;

        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                this.btn_like = document.querySelector('.btn-like');
                _context3.next = 3;
                return this.initDatabase();

              case 3:
                this.on(PlugAPI_1.EVENTS.CHAT, function (message) {
                  var match = message.message.match(/^\!([\s\S]+)\b/);

                  if (message.un === _this.getUser().username) {
                    _this.markedToDelete.add(message.cid, 30000, function () {
                      return _this.deleteMessage(message.cid);
                    });
                  }

                  if (!match) {
                    if (message.message.includes(window.API.getUser().username)) {
                      return _this.sendMessageTo(message.un, 'Homi, num fale comigo não... Eu sou um bot! >:(');
                    }

                    return;
                  }

                  _this.commandListener(match[1], message);
                });
    ...
    key: "deleteMessage",
    value: function deleteMessage(cid) {
      window.API.moderateDeleteChat(cid);
      return this;
    }
  }, {
    key: "sendMessageTo",
    value: function sendMessageTo(username, message) {
      return this.sendMessage("@".concat(username, " ").concat(message));
    }
  }, {
    key: "on",
...
exports.Bot = Bot;
},{"./PlugAPI":"lib/PlugAPI.ts","./Database":"lib/Database.ts","./Blacklist":"lib/Blacklist.ts"}],"lib/Module.ts":[function(require,module,exports) {
"use strict";
...
var BotModule = /*#__PURE__*/function () {
  function BotModule() {
    _classCallCheck(this, BotModule);
  }

  _createClass(BotModule, [{
    key: "onRegister",
...
},{}],"modules/game/index.ts":[function(require,module,exports) {
"use strict";
...
var GameModule = /*#__PURE__*/function (_Module_1$BotModule) {
  _inherits(GameModule, _Module_1$BotModule);

  var _super = _createSuper(GameModule);

  function GameModule(games) {
    var _this;
  ...
  _createClass(GameModule, [{
    key: "onRegister",
    value: function onRegister() {
      var _iterator = _createForOfIteratorHelper(this.games),
          _step;
...
},{"../../lib/PlugAPI":"lib/PlugAPI.ts","../../lib/Module":"lib/Module.ts"}],"modules/putarias/index.ts":[function(require,module,exports) {
"use strict";
...
exports.PutariasModule = void 0;

var Module_1 = require("../../lib/Module");

var PutariasModule = /*#__PURE__*/function (_Module_1$BotModule) {
  _inherits(PutariasModule, _Module_1$BotModule);

  var _super = _createSuper(PutariasModule);

  function PutariasModule() {
    _classCallCheck(this, PutariasModule);

    return _super.apply(this, arguments);
  }

  _createClass(PutariasModule, [{
    key: "onRegister",
    value: function onRegister() {
      var _this = this;
      ...
      this.bot.commands.add({
        ...
        command: /^(?:dedada)\s+(.*)/i,
        handle: function handle(_ref, message) {
          var _ref2 = _slicedToArray(_ref, 2),
              _ = _ref2[0],
              pessoa = _ref2[1];

          return _this.dedada(pessoa, message.un);
        }
      });
      this.bot.commands.add({
        ...
        handle: function handle(_ref3, message) {
          var _ref4 = _slicedToArray(_ref3, 2),
              _ = _ref4[0],
              pergunta = _ref4[1];

          return _this.responda(pergunta, message.un);
        }
      });
      this.bot.commands.add({
        ...
        handle: function handle(_, message) {
          return _this.elogiar();
        }
      });
      this.bot.commands.add({
        ...
        handle: function handle(_, message) {
          return _this.depreciar();
        }
      });
    }
  }, {
    key: "dedada",
    value: function dedada(pessoa, username) {
      if (pessoa.trim() === this.bot.getUser().username) {
        return this.bot.sendMessageTo(username, 'Vai dedar o cu do cãokkkkkkkkkkkkkkk');
      }

      this.bot.sendMessage("".concat(username, " deu uma dedada em ").concat(pessoa, " taporrakkkkkkkkkkkkkkkkkkkkk"));
    }
  }, {
    key: "responda",
    value: function responda(pergunta, username) {
      if (pergunta.match(/guei|gay/i)) return this.bot.sendMessageTo(username, 'Eu não tenho nada a ver com o toba dos outros.');
      var resposta = Math.random() >= 0.5 ? 'Sim' : 'Não';
      this.bot.sendMessageTo(username, resposta);
    }
  }, {
    key: "elogiar",
    value: function elogiar() {
      var _this$bot$getDj = this.bot.getDj(),
          username = _this$bot$getDj.username;

      this.bot.sendMessageTo(username, "Essa a\xED \xE9 melhor que uma coquinha gelada.");
    }
  }, {
    key: "depreciar",
    value: function depreciar() {
      var _this$bot$getDj2 = this.bot.getDj(),
          username = _this$bot$getDj2.username;

      this.bot.sendMessageTo(username, "Homi, tire essa poiquera...");
    }
  }]);

  return PutariasModule;
}(Module_1.BotModule);

exports.PutariasModule = PutariasModule;
},{"../../lib/Module":"lib/Module.ts"}],"modules/util/index.ts":[function(require,module,exports) {
"use strict";
...
var PlugAPI_1 = require("../../lib/PlugAPI");

var UtilModule = /*#__PURE__*/function (_Module_1$BotModule) {
  _inherits(UtilModule, _Module_1$BotModule);

  var _super = _createSuper(UtilModule);
  ...
  _createClass(UtilModule, [{
    key: "onRegister",
    value: function onRegister() {
      var _this = this;

      this.bot.on(PlugAPI_1.EVENTS.USER_JOIN, function (user) {
        return _this.boasVindas(user);
      });
      this.bot.commands.add({
        name: 'dj',
        descritpion: 'Exibe informações do DJ atual',
        command: /^dj/,
        handle: function handle(args, message) {
          return _this.verDj(message.un);
        }
      });
      this.bot.commands.add({
        name: 'ping',
      ...
      this.bot.commands.add({
        ...
        command: /^comandos/i,
        handle: function handle(args, message) {
          return _this.comandos(message.un);
        }
      });
      this.bot.commands.add({
        name: 'ajuda',
        ...
        handle: function handle(_ref, message) {
          ...
          return _this.ajuda(comando, message.un);
        }
      });
    }
  }, {
    key: "boasVindas",
    value: function boasVindas(user) {
      this.bot.sendMessage("Seja bem vindo!, ".concat(user.username, "!"));
    }
  }, {
    key: "verDj",
    value: function verDj(username) {
      var dj = this.bot.getDj();
      if (!dj) this.bot.sendMessageTo(username, "N\xE3o ningu\xE9m tocando :(");
      this.bot.sendMessageTo(username, "Nome: ".concat(dj.username, "; N\xEDvel: ").concat(dj.level, "; Idioma: ").concat(dj.language));
    }
  }, {
    key: "ping",
    value: function ping(username) {
      this.bot.sendMessageTo(username, 'Pong!');
    }
  }, {
    key: "comandos",
    value: function comandos(username) {
      var commands = _toConsumableArray(this.bot.commands).map(function (c) {
        return Array.isArray(c.name) ? "[".concat(c.name.join(', '), "]") : c.name;
      }).join(', ');
    ...
    key: "ajuda",
    value: function ajuda(comando, username) {
      comando = comando.toLowerCase();

      var result = _toConsumableArray(this.bot.commands).find(function (c) {
        if (typeof c.name === 'string') {
          return c.name.toLowerCase() === comando;
        }

        return c.name.some(function (cmd) {
          return cmd.toLowerCase() === comando;
        });
      });
      ...
      this.bot.sendMessageTo(username, "N\xE3o encontrei ajuda para o comando \"".concat(comando, "\""));
    }
  }]);
...
},{"../../lib/Module":"lib/Module.ts","../../lib/PlugAPI":"lib/PlugAPI.ts"}],"modules/song-info/api.ts":[function(require,module,exports) {
"use strict";
...
exports.getLyrics = exports.getInfo = void 0;
...
function _getInfo() {
  _getInfo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(media) {
    var title;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", fetch("https://ws.audioscrobbler.com/2.0/?method=track.getinfo&api_key=b25b959554ed76058ac220b7b2e0a026&artist=".concat(media.author, "&track=").concat(title)).then(function (res) {
              return res.text();
            }).then(function (text) {
              ...
              return {
                ...
                gender: Array.from(xml.querySelectorAll('toptags > tag > name')).map(function (e) {
...
function getLyrics(_x2) {
  return _getLyrics.apply(this, arguments);
}

function _getLyrics() {
  _getLyrics = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(media) {
    var title;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            title = normalizeTitle(media);
            return _context2.abrupt("return", fetch("https://api.vagalume.com.br/search.php?apikey=660a4395f992ff67786584e238f501aa&art=".concat(media.author, "&mus=").concat(title)).then(function (res) {
              return res.json();
            }).then(function (json) {
              return json.mus && json.mus[0].url;
            }));
...
},{}],"modules/song-info/index.ts":[function(require,module,exports) {
"use strict";
...
var SongInfoModule = /*#__PURE__*/function (_Module_1$BotModule) {
  _inherits(SongInfoModule, _Module_1$BotModule);

  var _super = _createSuper(SongInfoModule);

  function SongInfoModule() {
    var _this;

    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, SongInfoModule);
  ...
  _createClass(SongInfoModule, [{
    key: "onRegister",
    value: function onRegister() {
      this.bot.on(PlugAPI_1.EVENTS.ADVANCE, this.logger.bind(this)).on(PlugAPI_1.EVENTS.ADVANCE, this.antiGemidao.bind(this)).on(PlugAPI_1.EVENTS.ADVANCE, this.limiteTempo.bind(this)).on(PlugAPI_1.EVENTS.ADVANCE, this.autoWoot.bind(this));
      this.bot.commands.add({
        name: 'info',
    ...
    key: "autoWoot",
    value: function autoWoot() {
      this.bot.like();
    }
  }, {
    key: "logger",
    value: function logger(stat) {
      this.bot.sendMessage("Reproduzindo: ".concat(stat.media.title, " - ").concat(stat.media.author));
    }
  }, {
    key: "antiGemidao",
    value: function antiGemidao(stat) {
      clearTimeout(this.autoSkipTimer);
      var title = "".concat(stat.media.title, " - ").concat(stat.media.author);
    ...
    key: "limiteTempo",
    value: function limiteTempo(stat) {
      var _this2 = this;

      if (stat.media.duration > this.options.maxDuration) {
        this.bot.sendMessageTo(stat.dj.username, "Meu chapa, esta m\xFAsica ultrapassa o tempo m\xE1ximo de ".concat(this.options.maxDuration, " segundos, ap\xF3s esse tempo eu vou ter que pular. Beleza?"));
        this.autoSkipTimer = setTimeout(function () {
          return _this2.bot.skip();
    ...
    key: "info",
    value: function () {
      var _info = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_, _ref) {
        var username, info;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                username = _ref.un;
                _context.next = 3;
                return api_1.getInfo(this.bot.getMedia());
              ...
              case 3:
                ...
                return _context.abrupt("return", this.bot.sendMessageTo(username, "N\xE3o achei nada sobre essa m\xFAsica :("));

              case 6:
                this.bot.sendMessageTo(username, "T\xEDtulo: ".concat(info.title, "; Artista: ").concat(info.artist, "; Album: ").concat(info.album, "; G\xEAnero: ").concat(info.gender));
    ...
    key: "letra",
    value: function () {
      var _letra = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(_, _ref2) {
        var username, letra;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                username = _ref2.un;
                _context2.next = 3;
                return api_1.getLyrics(this.bot.getMedia());

              case 3:
                letra = _context2.sent;
                ...
                return _context2.abrupt("return", this.bot.sendMessageTo(username, "N\xE3o achei a letra desta m\xFAsica :("));
      ...
      function letra(_x3, _x4) {
        return _letra.apply(this, arguments);
      }
  ...
  return SongInfoModule;
}(Module_1.BotModule);

exports.SongInfoModule = SongInfoModule;
},{"../../lib/Module":"lib/Module.ts","../../lib/PlugAPI":"lib/PlugAPI.ts","./api":"modules/song-info/api.ts"}],"modules/game/game.ts":[function(require,module,exports) {
"use strict";
...
exports.Game = Game;
},{}],"modules/game/games/frutas.ts":[function(require,module,exports) {
"use strict";
...
exports.FrutasGame = void 0;

var game_1 = require("../game");

var Blacklist_1 = require("../../../lib/Blacklist");

var FrutasGame = /*#__PURE__*/function (_game_1$Game) {
  _inherits(FrutasGame, _game_1$Game);

  var _super = _createSuper(FrutasGame);

  function FrutasGame() {
    var _this;

    _classCallCheck(this, FrutasGame);

    _this = _super.apply(this, arguments);
    _this.name = 'Frutas';
    _this.descritpion = 'Digite !frutas, se sairem 3 frutas iguais você ganha o primeiro lugar da fila.';
    _this.command = /^frutas/i;
    _this.frutas = ['🍍', '🍌', '🍒', '🍎', '🍉', '🍓', '🍐', '🍊', '🍇'];
    _this.blacklist = new Blacklist_1.BlackList(60000);
    return _this;
  }

  _createClass(FrutasGame, [{
    key: "checkBlackList",
    value: function checkBlackList(username) {
      var time = this.blacklist.timeOf(username);

      if (time > 0) {
        var minutes = Math.ceil(time / 60000);
        this.bot.sendMessageTo(username, "Por favor aguarde ".concat(minutes, " minuto(s) para jogar novamente."));
        return true;
      }
    ...
    key: "handle",
    value: function handle(arg, message) {
      var _this2 = this;

      var username = message.un;

      if (this.checkBlackList(username)) {
        return;
      }

      var slots = new Array(3).fill(null).map(function () {
        return _this2.frutas[Math.floor(Math.random() * _this2.frutas.length)];
      });
      var set = new Set(slots);
      this.blacklist.add(username);

      if (set.size === 1) {
        this.bot.sendMessageTo(username, slots.join('') + " Parab\xE9ns, voc\xEA ganhou a primeira posi\xE7\xE3o! :D");

        if (!this.bot.moveDj(username, 1)) {
          this.bot.sendMessageTo(username, "Voc\xEA n\xE3o est\xE1 na fila!");
        }
      } else {
        this.bot.sendMessageTo(username, slots.join('') + " N\xE3o foi dessa vez! :(");
      }
    }
  }]);
...
exports.FrutasGame = FrutasGame;
},{"../game":"modules/game/game.ts","../../../lib/Blacklist":"lib/Blacklist.ts"}],"modules/game/games/dado.ts":[function(require,module,exports) {
"use strict";
...
exports.DadoGame = void 0;

var game_1 = require("../game");

var Blacklist_1 = require("../../../lib/Blacklist");

var DadoGame = /*#__PURE__*/function (_game_1$Game) {
  _inherits(DadoGame, _game_1$Game);

  var _super = _createSuper(DadoGame);

  function DadoGame() {
    var _this;

    _classCallCheck(this, DadoGame);

    _this = _super.apply(this, arguments);
    _this.name = 'Dado';
    _this.descritpion = 'Digite !dado <numero> se você acertar o número sorteado você ganha o primeiro lugar da fila.';
    _this.command = /^dados?/;
    _this.blacklist = new Blacklist_1.BlackList(60000);
    return _this;
  }

  _createClass(DadoGame, [{
    key: "checkBlackList",
    value: function checkBlackList(username) {
      var time = this.blacklist.timeOf(username);
    ...
    value: function handle(arg, message) {
      ...
      var numero = Number(arg);

      if (Number.isNaN(numero) || numero < 1 || numero > 6) {
        return this.bot.sendMessageTo(username, 'Você deve escolher um número de 1 à 6.');
      }

      var result = Math.round(Math.random() * 6);
      this.blacklist.add(username);

      if (result === numero) {
        this.bot.sendMessageTo(username, "[ ".concat(result, " ] Parab\xE9ns :D! Voc\xEA acertou o n\xFAmero e ser\xE1 movido(a) para a 1 primeira posi\xE7\xE3o da fila."));
      } else {
        this.bot.sendMessageTo(username, "[ ".concat(result, " ] N\xE3o foi dessa vez! :("));
      }
    }
  }]);
...
exports.DadoGame = DadoGame;
},{"../game":"modules/game/game.ts","../../../lib/Blacklist":"lib/Blacklist.ts"}],"modules/game/games/roleta.ts":[function(require,module,exports) {
"use strict";
...
exports.RoletaGame = void 0;

var game_1 = require("../game");

var RoletaGame = /*#__PURE__*/function (_game_1$Game) {
  _inherits(RoletaGame, _game_1$Game);

  var _super = _createSuper(RoletaGame);
  ...
  function RoletaGame() {
    ...
    _classCallCheck(this, RoletaGame);

    _this = _super.call(this);
    _this.name = 'Roleta';
    _this.descritpion = 'Quando a roleta iniciar, digite !entrar para entrar na roleta, se você for sorteado você ganha o primeiro lugar na fila.';
    _this.command = /^roleta/i;
    _this.started = false;
    _this.users = new Set();
    ...
    _this.options.time *= 60000;
    _this.options.interval *= 60000;
  ...
  _createClass(RoletaGame, [{
    ...
    value: function onRegister() {
      ...
      this.bot.commands.add({
        ...
        command: /^sair/i,
        handle: function handle(_, message) {
          return _this2.leave(message.un);
        }
      });
    }
  }, {
    ...
    value: function join(username) {
      if (!this.started) return this.bot.sendMessageTo(username, "A roleta n\xE3o est\xE1 iniciada.");
      if (!this.bot.userIsInWaitList(username)) return this.bot.sendMessageTo(username, "Para entrar na roleta voc\xEA deve antes entrar na fila.");
    ...
    value: function run() {
      this.started = false;
      if (!this.users.size) return this.bot.sendMessage("Ningu\xE9m ganhou a roleta pois n\xE3o houve participantes.");

      var users = _toConsumableArray(this.users);

      var user = users[Math.floor(Math.random() * users.length)];
      this.bot.sendMessage("@".concat(user, " ganhou a roleta, e ser\xE1 movido para a primeira posi\xE7\xE3o. :D"));
...
exports.RoletaGame = RoletaGame;
},{"../game":"modules/game/game.ts"}],"index.ts":[function(require,module,exports) {
"use strict";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "38117" + '/');
